...
- `reports/mechanism-review-circulation-readiness.md` reports `ready_for_mechanism_review` with `Blocked gates: 0`; it is a post-package verifier, so it should be regenerated after the Wiley, blinded-review, DOI package, DOI readiness, reviewer-risk, final-readthrough-evidence, and claim-boundary reports.
...
- Confirm the Wiley submission archive includes `supporting-information/final-human-readthrough.md`, `supporting-information/final-human-readthrough-audit.md`, `supporting-information/final-readthrough-evidence.md`, `supporting-information/first-wave-manual-adjudication-plan.md`, `supporting-information/procurement-causal-upgrade-packet.md`, `supporting-information/substitution-causal-upgrade-packet.md`, `supporting-information/comment-causal-upgrade-packet.md`, and `supporting-information/venue-causal-upgrade-packet.md`; these files record final human editorial signoff, the structured audit that prevents a stale or incomplete signoff from clearing, the automated evidence mapped to each scholarly read-through item, the candidate-product review queue that remains outside source evidence until promoted, and the procurement-, substitution-, comment-, and venue-specific causal-upgrade blockers that keep stronger claims bounded.
...
- Confirm `reports/mechanism-review-circulation-readiness.{csv,md}` was regenerated after DOI readiness. This post-package report is intentionally not copied into the Wiley ZIP; it verifies that mechanism-review circulation is ready while DOI, human signoff, same-day external checks, and calibrated policy-effect claims remain separately gated.
