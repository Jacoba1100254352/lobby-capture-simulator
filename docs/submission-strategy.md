...
- `make reggov-guidelines-readiness-audit` checks the locally verifiable Regulation & Governance/Wiley guideline surface after the Wiley upload-form audit: journal target metadata, original-article wrapper, preferred and normal word limits, the 150-word abstract cap, extractable abstract and keywords, author/correspondence metadata, data/code availability, AI/funding/conflict statements, figures, tables, supporting information, and LaTeX package contents. It remains separate from the ZIP and records whether the live journal author-page refresh has been completed for the current release.
