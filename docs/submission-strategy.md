...
Reason: the paper is strongest as a regulatory-governance mechanism article about how anti-capture reforms interact across transparency, enforcement, rulemaking, procurement, public financing, dark money, and revolving-door constraints. The current official-page search excerpt for Regulation & Governance reports a preferred first-submission length of 8,000-10,000 words, inclusive of abstract, article, references, endnotes, tables, and figures.
...
- `make reggov-guidelines-readiness-audit` checks the locally verifiable Regulation & Governance/Wiley guideline surface after the Wiley upload-form audit: journal target metadata, original-article wrapper, 8,000-10,000-word preferred range, extractable abstract and keywords, author/correspondence metadata, data/code availability, AI/funding/conflict statements, figures, tables, supporting information, and LaTeX package contents. It remains separate from the ZIP and records the live journal author-page refresh as a manual final-submission control.
