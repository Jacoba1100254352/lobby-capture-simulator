...
- use the candidate-only entity-resolution seed files to select high-value actor names for manual `canonicalActorId`, alias-decision, false-match, issue-crosswalk, and linked actor-issue-venue-time adjudication;
