...
- `make first-wave-entity-resolution-seeds` turns the linkage-candidate report into candidate-only source-product seed files under `data/calibration/first-wave/` without marking them estimation-ready.
