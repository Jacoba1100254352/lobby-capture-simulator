...
- `normalized-fec-campaign-finance.csv` constrains donor concentration, Schedule E outside-spending pressure, electioneering and communication-cost coverage, and traceability; `normalized-public-financing.csv` and `normalized-dark-money.csv` carry separate public-financing and opaque-capacity bridge rows.
...
- FEC: normalized 2024 OpenFEC rows, including six national party committee requests, Schedule E independent expenditures, and optional electioneering/communication-cost rows.
