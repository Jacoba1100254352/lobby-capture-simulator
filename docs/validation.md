...
- source-native `--live` mode queries LDA, OpenFEC, Regulations.gov, Federal Register, USAspending, NYC CFB, Seattle Democracy Voucher, IRS EO BMF, IRS POFD Form 8872, or LDA-derived covered-position revolving-door records when no explicit CSV/URL is supplied.
