...
- Source calibration is currently strongest for LDA, OpenFEC party-committee and Schedule E rows, NYC CFB public-financing/intermediary rows, IRS EO BMF nonprofit-capacity rows, Federal Register/Regulations.gov schemas, USAspending award concentration, USAspending procurement bridge fields, the USAspending procurement action-panel parser, and LDA-derived covered-position revolving-door rows. OpenFEC electioneering and communication-cost channels are parser-supported but absent from the pinned snapshot, so they are not empirical bridge rows yet. Source calibration remains weakest for observed dark-money transactions, representative SAM/FPDS action-level procurement histories, full 527/Form 990 intermediary records, and representative personnel-movement revolving-door exports.
