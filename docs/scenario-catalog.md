...
- Source calibration is strongest for LDA, OpenFEC party-committee and Schedule E rows, NYC CFB public-financing/intermediary rows, Seattle Democracy Voucher rows, IRS EO BMF nonprofit-capacity rows, bounded ProPublica/IRS Schedule I nonprofit-routing rows for top dark-money-capacity EINs, bounded IRS POFD Form 8872 rows for 527 political organizations, Federal Register/Regulations.gov schemas, USAspending award concentration, USAspending procurement bridge fields, the USAspending procurement action-panel parser, the archived USAspending bulk transaction summary, the procurement benchmark crosswalk, the opt-in SAM.gov Contract Awards parser, and LDA-derived covered-position revolving-door rows. OpenFEC electioneering and communication-cost rows are included in the pinned snapshot as a bounded electoral-communication bridge. Source calibration remains weakest for hidden-donor identity evidence, representative national public-financing coverage, SAM/FPDS crosswalks for procurement modification coding, representative all-organization Form 990 intermediary routing beyond the top-EIN Schedule I slice, complete IRS 527 coverage beyond the bounded alphabetic slice, and representative personnel-movement revolving-door exports.
