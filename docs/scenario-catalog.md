...
- Source calibration is currently strongest for LDA, OpenFEC party-committee, Schedule E, electioneering, and communication-cost parser paths, NYC CFB public-financing/intermediary rows, IRS EO BMF nonprofit-capacity rows, Federal Register/Regulations.gov schemas, USAspending award concentration, USAspending procurement bridge fields, the USAspending procurement action-panel parser, and LDA-derived covered-position revolving-door rows. It remains weakest for observed dark-money transactions, representative SAM/FPDS action-level procurement histories, full 527/Form 990 intermediary records, and representative personnel-movement revolving-door exports.
