...
sam-contract-awards-preflight-extract:
	SAM_CONTRACT_AWARDS_PREFLIGHT_EXTRACT_MODE=1 python3 scripts/probe-sam-contract-awards.py

sam-contract-awards-preflight-offset:
	SAM_CONTRACT_AWARDS_PREFLIGHT_EXTRACT_MODE=0 python3 scripts/probe-sam-contract-awards.py
...
sam-contract-awards-record-fresh-link:
	python3 scripts/record-sam-export-link.py --input - --assume-fresh
...
gao-protest-feed-preflight:
	@. ./scripts/load-env.sh; python3 scripts/probe-gao-protest-feed.py
...
literature-positioning-audit:
	python3 scripts/audit-literature-positioning.py

reference-integrity-audit:
	python3 scripts/audit-reference-integrity.py
...
reviewer-risk-register: submission-readiness-audit calibration-readiness-audit claim-source-dependency-audit causal-calibration-targets source-capability-audit source-panel-inventory procurement-refresh-readiness first-wave-procurement-source-acquisition final-human-readthrough-audit
...
final-readthrough-evidence: final-human-readthrough-audit literature-positioning-audit reference-integrity-audit submission-readiness-audit reviewer-risk-register latex-log-audit paper-structure-audit archive-handoff-audit reggov-guidelines-readiness-audit
...
clean: scrub-copy-suffix-artifacts
	...
	rm -f reports/reference-integrity-audit.csv reports/reference-integrity-audit.md
	rm -f reports/final-human-readthrough-audit.csv reports/final-human-readthrough-audit.md
	rm -f reports/paper-structure-audit.csv reports/paper-structure-audit.md
