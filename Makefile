...
first-wave-source-readiness: first-wave-causal-protocols source-capability-audit procurement-refresh-readiness
...
submission-package: paper-wiley paper-supplement paper-word-count visual-review-checklist latex-log-audit policy-claim-language-audit submission-readiness-audit first-wave-causal-protocols first-wave-source-readiness submission-package-build submission-package-check archive-handoff-audit
...
submission-readiness-audit: policy-claim-language-audit
...
doi-deposit-readiness-audit: archive-handoff-audit
