...
sam-exclusions-preflight:
	@. ./scripts/load-env.sh; python3 scripts/probe-sam-exclusions.py
...
gao-protest-overlay-candidates:
	@. ./scripts/load-env.sh; python3 scripts/probe-gao-protest-feed.py --overlay-candidate-output data/calibration/first-wave/gao-protest-overlay.csv
...
blinded-review-package-check: blinded-review-package-build
	python3 scripts/check-blinded-review-package.py

blinded-review-package: blinded-review-package-check
...
github-release-upload-paths:
	@python3 scripts/audit-github-release-assets.py --print-upload-paths
...
release-postflight: github-release-asset-audit github-ci-status-audit external-finalization-checklist
...
clean: scrub-copy-suffix-artifacts
	...
	rm -f reports/blinded-review-package-readiness.csv reports/blinded-review-package-readiness.md
	...
	rm -f reports/sam-exclusions-preflight.csv reports/sam-exclusions-preflight.md
