...
| Procurement modification risk | Post-award modification and specification-change pressure | proxy/thin | `procurementExPostModificationShare` | 0.0000 | yes | warning | latest-transaction modification enrichment is available but kept separate from action-level incidence; representative transaction denominators are still absent | Separate initial awards from post-award modifications and validate nonzero modification numbers against FPDS transactions. |
