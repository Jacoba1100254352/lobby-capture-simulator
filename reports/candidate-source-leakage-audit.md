...
| manual-adjudication-burden | pass | candidateProducts=13; candidateRows=3949; markerRows=3949; reviewedRows=0; reviewerDateGaps=205; minimumRowShortfalls=4; priorities=P1=7; P2=6 | candidateRows=markerRows; reviewedRows=0 while candidate gate is active | The remaining empirical work is measurable manual adjudication, not untracked missingness: candidate files identify source-product rows that must be reviewed before promotion. | Prioritize the largest P1/P2 candidate products, replace candidate markers with reviewed source rows, and rerun first-wave source-product, readiness, candidate-leakage, and artifact gates before strengthening claims. |
...
| summary | pass | checks=5; Failures=0 | Failures=0 | Candidate-only source-product worklists remain blocked from estimation and calibrated policy claims. | Keep this audit in the publication bundle and rerun it after every source-product or readiness edit. |

## Manual Adjudication Burden

- byTarget: comment-authenticity-and-uptake-effect:products=1,rows=80,markers=80; procurement-modification-causal-capture:products=5,rows=5,markers=5; substitution-elasticity:products=2,rows=1580,markers=1580; venue-shifting-detection-effect:products=5,rows=2284,markers=2284
...
- minimumRowShortfalls: sam-fpds-action-history-crosswalk:1/5000; gao-protest-overlay:1/25; sam-exclusion-overlay:1/25; procurement-offer-competition-enrichment:1/5000
