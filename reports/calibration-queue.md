...
| P1 | direct-source-moment | source-moments.csv | `procurementExPostModificationShare` | source_gap | 0.0000-0.0000 | 0.01-0.05 | procurementExPostModificationShare=0.0000 | populate the procurement action panel with representative USAspending/SAM/FPDS action-level modification transactions before treating modification incidence as calibrated |
...
| P3 | model-tuning | lobby-capture-campaign.csv | `largeDonorDependence` | partial | 0.5702-0.7009 | 0.60-0.80 | fecLargeDonorWeightedShare=0.9485 | inspect remaining campaign/outside rows and tune allocation-to-source concentration only where high-end outside spending is intended |
