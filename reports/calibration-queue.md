...
- `benchmark-review`: `12`
- `direct-source-moment`: `2`
- `scenario-coverage`: `5`
- `scenario-family-split`: `1`

| Priority | Category | Report | Metric | Status | Observed | Benchmark | Source Moment | Action |
| --- | --- | --- | --- | --- | ---: | ---: | ---: | --- |
| P1 | direct-source-moment | source-moments.csv | `procurementExPostModificationShare` | source_gap | 0.1702-0.1702 | 0.01-0.05 | procurementExPostModificationShare=0.1702 | use the archived USAspending bulk action-row, distinct-award, and amount-weighted modification diagnostics to remap the benchmark; add SAM/FPDS action-history exports only to crosswalk USAspending modification coding before treating modification incidence as calibrated |
| P1 | direct-source-moment | source-moments.csv | `procurementRecipientTop3Share` | source_gap | 0.1141-0.1141 | 0.25-0.40 | procurementRecipientTop3Share=0.1141 | use the archived USAspending bulk summary for public concentration diagnostics, then remap the top-contractor benchmark by award type, agency mix, and fiscal year before treating recipient concentration as calibrated |
