...
| Strategic substitution mechanism | Outside spending; Intermediaries; IRS 527 political organizations; Procurement identifiers | Direct dark money (thin); Revolving door (thin) | outsideSpendingRows=918 (ok); intermediaryRows=1353 (ok); intermediary527Rows=500 (ok); revolvingDoorRows=284 (ok) |
...
| Hidden-channel magnitude | Electoral communications | Direct dark money (thin); Revolving door (thin) | darkMoneySourceShare=0.0245 (ok); electoralCommunicationRows=268 (ok) |
| Procurement modification capture | Procurement action history | Procurement concentration panel (thin); Procurement modification risk (thin) | procurementConcentrationPanelAgencyCount=6 (ok); procurementActionRows=3578 (ok); procurementExPostModificationShare=0.3111 (ok) |
| Calibrated policy simulation | Electoral communications; Public financing; IRS 527 political organizations; Procurement action history | Direct dark money (thin); Revolving door (thin); Procurement concentration panel (thin); Procurement modification risk (thin) | electoralCommunicationRows=268 (ok); intermediary527Rows=500 (ok); procurementActionRows=3578 (ok) |
