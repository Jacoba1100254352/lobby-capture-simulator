...
| Strategic substitution mechanism | bounded | Bounded by weak panels: Direct dark money (fixture-only). | Mechanism tests and source-aware stress diagnostics for channel substitution. | Do not present hidden substitution magnitudes as empirically validated. | Replace thin hidden-channel panels with direct routing, personnel, and transaction exports. |
...
| Hidden-channel magnitude | not_cleared | Not cleared because of weak panels: Direct dark money (fixture-only); missing moment thresholds: darkMoneyDirectRoutingRows<1. | Missingness and proxy-gap diagnosis for hidden-channel mechanisms. | Do not treat bounded electoral-communication rows as hidden-donor or hidden-channel magnitude evidence. | Add direct hidden-donor or nonprofit-routing evidence plus broader electoral-communication coverage. |
...
| Calibrated policy simulation | not_cleared | Not cleared because of weak panels: Direct dark money (fixture-only), Procurement modification risk (thin); missing moment thresholds: darkMoneyDirectRoutingRows<1. | Not cleared; the current article can only use mechanism diagnostics and bounded source moments. | Do not describe the artifact as a calibrated policy-effect simulator. | Clear the P1/P2 source gaps and rerun validation before using calibrated policy language. |
...
| Visible electoral money | Outside spending | none | fecRows=1268 (ok); outsideSpendingRows=918 (ok) |
...
| Strategic substitution mechanism | Outside spending; Intermediaries; IRS 527 political organizations; Revolving door; Procurement identifiers | Direct dark money (fixture-only) | outsideSpendingRows=918 (ok); intermediaryRows=1353 (ok); intermediary527Rows=500 (ok); revolvingDoorRows=803 (ok) |
...
| Hidden-channel magnitude | Electoral communications; Revolving door | Direct dark money (fixture-only) | darkMoneyDirectRoutingRows=0 (gap); electoralCommunicationRows=268 (ok) |
| Procurement modification capture | Procurement concentration panel; Procurement action history | Procurement modification risk (thin) | procurementConcentrationPanelAgencyCount=12 (ok); procurementActionRows=2399 (ok); procurementExPostModificationShare=0.3297 (ok) |
| Calibrated policy simulation | Electoral communications; Public financing; IRS 527 political organizations; Revolving door; Procurement concentration panel; Procurement action history | Direct dark money (fixture-only); Procurement modification risk (thin) | darkMoneyDirectRoutingRows=0 (gap); electoralCommunicationRows=268 (ok); intermediary527Rows=500 (ok); procurementActionRows=2399 (ok) |
