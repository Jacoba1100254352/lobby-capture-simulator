...
| Calibrated policy simulation | Electoral communications; Public financing; IRS 527 political organizations; Procurement concentration panel; Procurement action history | Direct dark money (thin); Revolving door (thin); Procurement modification risk (thin) | electoralCommunicationRows=268 (ok); intermediary527Rows=500 (ok); procurementActionRows=2399 (ok) |
