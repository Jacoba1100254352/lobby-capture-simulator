...
| Procurement modification capture | Procurement action history | Procurement concentration bridge (thin); Procurement modification risk (thin) | procurementBridgeAgencyCount=6 (ok); procurementActionRows=3578 (ok); procurementExPostModificationShare=0.3111 (ok) |
| Calibrated policy simulation | Electoral communications; Public financing; IRS 527 political organizations; Procurement action history | Direct dark money (thin); Revolving door (thin); Procurement concentration bridge (thin); Procurement modification risk (thin) | electoralCommunicationRows=268 (ok); intermediary527Rows=500 (ok); procurementActionRows=3578 (ok) |
