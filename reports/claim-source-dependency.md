...
| Strategic substitution mechanism | Outside spending; Intermediaries; IRS 527 political organizations; Procurement identifiers | Direct dark money (thin); Revolving door (thin) | outsideSpendingRows=919 (ok); intermediaryRows=1353 (ok); intermediary527Rows=500 (ok); revolvingDoorRows=284 (ok) |
