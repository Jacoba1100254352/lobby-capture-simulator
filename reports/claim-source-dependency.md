...
| Calibrated policy simulation | Electoral communications; IRS 527 political organizations; Procurement action history | Direct dark money (thin); Public financing (thin); Revolving door (thin); Procurement concentration bridge (thin); Procurement modification risk (warning) | electoralCommunicationRows=269 (ok); intermediary527Rows=500 (ok); procurementActionRows=1200 (ok) |
