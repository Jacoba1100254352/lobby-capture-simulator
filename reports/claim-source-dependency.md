...
| Strategic substitution mechanism | bounded | Bounded by weak panels: Direct dark money (thin). | Mechanism tests and source-aware stress diagnostics for channel substitution. | Do not present hidden substitution magnitudes as empirically validated. | Replace thin hidden-channel panels with direct routing, personnel, and transaction exports. |
...
| Hidden-channel magnitude | not_cleared | Not cleared because of weak panels: Direct dark money (thin). | Missingness and proxy-gap diagnosis for hidden-channel mechanisms. | Do not treat bounded electoral-communication rows as hidden-donor or hidden-channel magnitude evidence. | Add direct hidden-donor or nonprofit-routing evidence plus broader electoral-communication coverage. |
...
| Strategic substitution mechanism | Outside spending; Intermediaries; IRS 527 political organizations; Revolving door; Procurement identifiers | Direct dark money (thin) | outsideSpendingRows=918 (ok); intermediaryRows=1353 (ok); intermediary527Rows=500 (ok); revolvingDoorRows=803 (ok) |
...
| Hidden-channel magnitude | Electoral communications; Revolving door | Direct dark money (thin) | darkMoneySourceShare=0.0245 (ok); electoralCommunicationRows=268 (ok) |
...
| Calibrated policy simulation | Electoral communications; Public financing; IRS 527 political organizations; Revolving door; Procurement concentration panel; Procurement action history | Direct dark money (thin); Procurement modification risk (thin) | electoralCommunicationRows=268 (ok); intermediary527Rows=500 (ok); procurementActionRows=2399 (ok) |
