...
| doi-deposit-package | ready | package=present; manifest=present; manifest members=30; zip members=32; primary assets=4/4; zip integrity=ok; package checksum=ok | Upload or retain dist/lobby-capture-doi-deposit-package.zip as the single archive handoff package when the repository-to-archive integration does not preserve release assets directly. |
