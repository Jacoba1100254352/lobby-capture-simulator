...
| --- | --- | --- | --- |
| release-metadata | ready | CITATION release=paper-publication-readiness-2026-06-18-r176; Zenodo related release=present | Use these metadata as the deposit record source. |
...
| human-readthrough | manual_required | release=paper-publication-readiness-2026-06-18-r176; status=pending; blocked=0; manual_required=18; checkedChecklistItems=3/17 | Complete the final human scholarly read-through against the exact release tag before final journal submission. |
