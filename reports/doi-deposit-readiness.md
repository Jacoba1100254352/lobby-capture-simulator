...
| --- | --- | --- | --- |
| release-metadata | ready | CITATION release=paper-publication-readiness-2026-06-18-r143; Zenodo related release=present | Use these metadata as the deposit record source. |
...
| human-readthrough | manual_required | status=pending; reviewed-release=paper-publication-readiness-2026-06-18-r143; expected-release=paper-publication-readiness-2026-06-18-r143; signer=missing; date=missing; commit=missing | Complete the final human scholarly read-through against the exact release tag before final journal submission. |
