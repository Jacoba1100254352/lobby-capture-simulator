...
| layout-and-visual-audit | ready | layout failures=0; visual checklist=pass | Figures, tables, and generated PDFs pass the automated layout and label-readability checks. | Inspect and rerun the visual/layout audits after any figure, table, or LaTeX change. |
