...
| Procurement concentration panel | Multi-agency vendor and agency concentration diagnostics | bounded national action panel | usable | stronger | May support mechanism diagnostics and distributional anchoring within the stated source scope. | Do not present as a causal estimate or nationally representative policy effect. | Use the no-agency-filtered USAspending national action panel for concentration diagnostics and representative SAM/FPDS action-level extracts before treating modification incidence as calibrated. |
