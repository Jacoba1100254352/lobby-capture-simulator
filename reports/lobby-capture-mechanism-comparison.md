...
This report compares low-, moderate-, and strong-reform families under three model modes: a visible single-channel baseline, a multi-channel model with substitution disabled, and a multi-channel substitution model.
...
| Family | Model mode | Capture | Capture SD | Hidden influence | Hidden SD | Hidden capture | Total distortion | Distortion SD | Substitution risk |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Low | Visible scalar | 0.7344 | 0.0550 | 0.0000 | 0.0000 | 0.0043 | 0.2644 | 0.0132 | 0.0333 |
| Low | Multi-channel/no substitution | 0.7891 | 0.0474 | 0.0000 | 0.0000 | 0.0040 | 0.2886 | 0.0109 | 0.0510 |
