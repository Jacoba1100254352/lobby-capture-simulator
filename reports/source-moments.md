...
| snapshot | usaspending | `procurementActionRows` | 28115.0000 | observed | primary procurement action denominator from stratified USAspending transaction/action rows |
| snapshot | usaspending | `procurementUsaspendingActionRows` | 28115.0000 | observed | normalized USAspending transaction/action rows, if available |
...
| snapshot | usaspending | `procurementModificationPanelRows` | 28115.0000 | diagnostic | rows used for modification moments from stratified USAspending transaction/action rows |
...
| snapshot | usaspending | `procurementTotalAwards` | 194287.3468 | observed | sum of national-volume no-agency-filtered USAspending transaction/action rows amount |
...
| snapshot | usaspending | `procurementInitialAwardShare` | 0.5780 | observed_proxy | share of stratified USAspending transaction/action rows that appear to be initial awards |
| snapshot | usaspending | `procurementExPostModificationShare` | 0.4220 | observed_proxy | share of stratified USAspending transaction/action rows marked as ex-post modifications or nonzero modification sequence |
| snapshot | usaspending | `procurementActionDistinctAwards` | 23819.0000 | diagnostic | distinct PIID/award identifiers in stratified USAspending transaction/action rows used for award-level modification diagnostics |
| snapshot | usaspending | `procurementModifiedAwardCount` | 8199.0000 | diagnostic | distinct PIID/award identifiers in stratified USAspending transaction/action rows with at least one ex-post modification row |
...
| snapshot | usaspending | `procurementModificationActionsPerModifiedAward` | 1.4470 | diagnostic | mean modified action rows per modified PIID/award identifier in stratified USAspending transaction/action rows |
...
| snapshot | usaspending | `procurementActionModificationRows` | 11864.0000 | diagnostic | primary transaction/action rows from stratified USAspending transaction/action rows marked as ex-post modifications |
