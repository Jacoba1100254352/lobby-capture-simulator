...
| snapshot | usaspending | `procurementConcentrationPanelActionSample` | 1.0000 | diagnostic | 1 when procurement concentration moments use the transaction/action panel |
...
| fixture | usaspending | `procurementConcentrationPanelActionSample` | 0.0000 | diagnostic | 1 when procurement concentration moments use the transaction/action panel |
