...
| snapshot | usaspending | `procurementLatestTransactionModificationProxy` | 1.0000 | diagnostic | 1 when modification moments use latest-transaction enrichment rather than action-level FPDS denominator |
...
| snapshot | usaspending | `procurementSingleBidShare` | 0.2933 | observed_proxy | share of rows with one known offer |
| snapshot | usaspending | `procurementAmountWeightedSingleBidShare` | 0.2980 | observed_proxy | award-amount share with one known offer |
...
| snapshot | usaspending | `procurementPriceOnlyAwardShare` | 0.6133 | observed_proxy | share of rows marked as price-only or one-offer awards |
| snapshot | usaspending | `procurementLimitedCompetitionShare` | 0.4000 | observed_proxy | share of rows with limited competition, exclusions, or one known offer |
| snapshot | usaspending | `procurementProtestShare` | 0.0000 | observed_proxy | share of rows marked with a protest flag |
| snapshot | usaspending | `procurementExclusionShare` | 0.0933 | observed_proxy | share of rows marked as exclusions or after-exclusion competition |
...
| fixture | usaspending | `procurementLatestTransactionModificationProxy` | 0.0000 | diagnostic | 1 when modification moments use latest-transaction enrichment rather than action-level FPDS denominator |
...
| fixture | usaspending | `procurementInitialAwardShare` | 0.4000 | observed_proxy | share of rows that appear to be initial awards rather than modifications |
| fixture | usaspending | `procurementExPostModificationShare` | 0.6000 | observed_proxy | share of rows marked as ex-post modifications or nonzero modification sequence |
| fixture | usaspending | `procurementAmountWeightedModificationShare` | 0.5571 | observed_proxy | award-amount share marked as ex-post modifications |
...
| fixture | usaspending | `procurementLimitedCompetitionShare` | 0.4000 | observed_proxy | share of rows with limited competition, exclusions, or one known offer |
| fixture | usaspending | `procurementProtestShare` | 0.0000 | observed_proxy | share of rows marked with a protest flag |
| fixture | usaspending | `procurementExclusionShare` | 0.0000 | observed_proxy | share of rows marked as exclusions or after-exclusion competition |
