...
| --- | --- | --- | --- |
| submission-archive-present | ready | exists=yes; readable=yes; encrypted=no; members=yes | Upload the ZIP only if it opens without encryption or structural errors. |
| upload-size | ready | combined upload size=within limit; upload files present=3/3; limit=524288000 | Keep the LaTeX ZIP, compiled PDF, and supplement below Wiley's 500 MB combined-file limit. |
