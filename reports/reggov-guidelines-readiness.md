...
- Blocked gates: `0`
- Word limit checked: `11,000` words including abstract, references, endnotes, tables, and figures
...
| word-limit | ready | approximate words=5712; Regulation & Governance reported limit=11000 | Shorten the manuscript if the approximate count exceeds the journal cap. |
