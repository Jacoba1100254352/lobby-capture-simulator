...
| supporting-information-format-size | ready | supporting members=225; largest=within-limit; limit=10485760; oversized=none; unlabeled=none | Keep every supporting-information member clearly labeled and at or below Wiley's 10 MB per-file guidance. |
| latex-submission-files | ready | exists=yes; readable=yes; encrypted=no; members=282; strategic-channel-substitution-regulatory-capture.tex=yes; strategic-channel-substitution-regulatory-capture.pdf=yes; references.bib=yes; USG.cls=yes; lettersp.sty=yes; wileyNJD-Chicago.bst=yes; supporting-information/submission-package-manifest.json=yes; supporting-information/submission-package-manifest.md=yes; Wiley form ready gates=7 | Keep the ZIP, root .tex, compiled PDF, bibliography, class/style files, figures, tables, and package manifest together. |
