...
- Version: `paper-publication-readiness-2026-06-18-r156`
...
| --- | --- | --- | --- |
| metadata-json | ready | title=present; creators=1; version=paper-publication-readiness-2026-06-18-r156; expected=paper-publication-readiness-2026-06-18-r156; license=mit-license | Keep .zenodo.json and CITATION.cff synchronized before DOI deposit. |
...
| archive-manifest | ready | releaseTag=paper-publication-readiness-2026-06-18-r156; expected=paper-publication-readiness-2026-06-18-r156 | Regenerate the archive handoff manifest before a DOI upload. |
