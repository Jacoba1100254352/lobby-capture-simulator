...
- Version: `paper-publication-readiness-2026-06-18-r183`
...
| --- | --- | --- | --- |
| metadata-json | ready | title=present; creators=1; version=paper-publication-readiness-2026-06-18-r183; expected=paper-publication-readiness-2026-06-18-r183; license=mit-license | Keep .zenodo.json and CITATION.cff synchronized before DOI deposit. |
...
| token | manual_required | tokenVariable=missing; token=missing | Set ZENODO_ACCESS_TOKEN, ZENODO_API_TOKEN, ZENODO_TOKEN, or the target-specific sandbox/production token in .env before creating an unpublished draft. |
| doi-package | ready | package=present; checksum=ok; byte-level record=dist/doi-deposit-package-checksum.* | Run make doi-deposit-package before a Zenodo upload. |
| archive-manifest | ready | releaseTag=paper-publication-readiness-2026-06-18-r183; expected=paper-publication-readiness-2026-06-18-r183 | Regenerate the archive handoff manifest before a DOI upload. |
