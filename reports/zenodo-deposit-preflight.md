...
| --- | --- | --- | --- |
| metadata-json | ready | title=present; creators=1; version=paper-publication-readiness-2026-06-18-r160; expected=paper-publication-readiness-2026-06-18-r160; license=mit-license | Keep .zenodo.json and CITATION.cff synchronized before DOI deposit. |
...
| archive-manifest | ready | releaseTag=paper-publication-readiness-2026-06-18-r160; expected=paper-publication-readiness-2026-06-18-r160 | Regenerate the archive handoff manifest before a DOI upload. |
