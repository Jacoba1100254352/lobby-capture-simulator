...
| --- | --- | --- | --- |
| metadata-json | ready | title=present; creators=1; version=paper-publication-readiness-2026-06-18-r164; expected=paper-publication-readiness-2026-06-18-r164; license=mit-license | Keep .zenodo.json and CITATION.cff synchronized before DOI deposit. |
...
| archive-manifest | ready | releaseTag=paper-publication-readiness-2026-06-18-r164; expected=paper-publication-readiness-2026-06-18-r164 | Regenerate the archive handoff manifest before a DOI upload. |
