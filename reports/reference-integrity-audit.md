...
| source-metadata | federalRegisterApi | ready | accessedNote=yes; url=yes |
| source-metadata | irsEoBmf | ready | accessedNote=yes; url=yes |
| source-metadata | ldaData | ready | accessedNote=yes; url=yes |
| source-metadata | nycCfbData | ready | accessedNote=yes; url=yes |
| source-metadata | regulationsGovApi | ready | accessedNote=yes; url=yes |
| source-metadata | seattleVouchers | ready | accessedNote=yes; url=yes |
| source-metadata | usaspending | ready | accessedNote=yes; url=yes |
