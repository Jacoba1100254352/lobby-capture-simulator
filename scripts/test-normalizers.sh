...
with ci_csv.open("w", newline="", encoding="utf-8") as target:
    ...
    writer.writerow({
        ...
        "status": "ready",
        "workflow": "local-git",
        "branchOrTag": "paper-publication-readiness-2026-06-18-r153",
        "headSha": "abc123",
        "runId": "",
        "runStatus": "completed",
        "conclusion": "success",
...
url: "https://github.com/Jacoba1100254352/lobby-capture-simulator/releases/tag/paper-publication-readiness-2026-06-18-r153"
license: MIT
preferred-citation:
  type: article
...
cat > "$tmpdir/doi-repo/.zenodo.json" <<'JSON'
{
  ...
  "related_identifiers": [
    {
      "identifier": "https://github.com/Jacoba1100254352/lobby-capture-simulator/releases/tag/paper-publication-readiness-2026-06-18-r153",
