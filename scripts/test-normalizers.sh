...
with ci_csv.open("w", newline="", encoding="utf-8") as target:
    ...
    writer.writerow({
        ...
        "status": "ready",
        "workflow": "local-git",
        "branchOrTag": "paper-publication-readiness-2026-06-18-r164",
        "headSha": "abc123",
        "runId": "",
        "runStatus": "completed",
        "conclusion": "success",
...
version: "paper-publication-readiness-2026-06-18-r164"
repository-code: "https://github.com/Jacoba1100254352/lobby-capture-simulator"
url: "https://github.com/Jacoba1100254352/lobby-capture-simulator/releases/tag/paper-publication-readiness-2026-06-18-r164"
license: MIT
preferred-citation:
  type: article
...
cat > "$tmpdir/doi-repo/.zenodo.json" <<'JSON'
{
  ...
  "related_identifiers": [
    {
      "identifier": "https://github.com/Jacoba1100254352/lobby-capture-simulator/releases/tag/paper-publication-readiness-2026-06-18-r164",
...
signed-off-by:
signed-off-date:
reviewed-release: paper-publication-readiness-2026-06-18-r164
reviewed-commit:
doi-archive:
MD
