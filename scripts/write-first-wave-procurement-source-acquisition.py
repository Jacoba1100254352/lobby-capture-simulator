...
SOURCE_ROWS = [
    ...
    },
    {
        ...
        "officialSourceUrl": "https://www.gao.gov/legal/bid-protests/recent; https://www.gao.gov/rss/reportslegal.xml",
        "fallbackSource": "Run make gao-protest-feed-preflight against the GAO Legal Products XML feed for discovery; the ignored worklist extracts B-numbers, decision dates, protester names, agency hints, awardee hints, coarse issue-code hints, and visible outcome language before source-page review",
        ...
        "acquisitionStep": "Run make gao-protest-feed-preflight to build an ignored GAO protest discovery worklist, review the high-priority rows against official decision pages or PDFs, then manually link decisions to PIID, UEI or vendor, agency, outcome, and issue fields before promotion.",
        ...
        "currentBlocker": "The GAO feed can discover recent bid-protest decisions and hints, but decision pages do not reliably expose PIID/UEI fields in a machine-readable way, so award/vendor linkage and outcome/issue coding remain manual review tasks.",
    },
    {
        ...
        "fallbackSource": "Run make sam-exclusions-preflight for a redacted quota/access check; use SAM_Exclusions_Public_Extract files from the official Entity/Exclusions Extracts API when a broad public extract is preferable",
        ...
        "acquisitionStep": "Run make sam-exclusions-preflight before source acquisition, then use the Exclusions API for targeted UEI/entity checks or the public exclusion extract for a broader panel; keep API keys in .env and archive only normalized public rows.",
        ...
        "currentBlocker": "Official API quota and extract access must be managed; the preflight records access state only, and broad extracts still require field normalization and source-date preservation.",
    },
    {
