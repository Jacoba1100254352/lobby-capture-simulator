...
SOURCE_ROWS = [
    ...
    },
    {
        ...
        "fallbackSource": "Run make gao-protest-feed-preflight against the GAO Legal Products XML feed for discovery, then review decision pages or PDFs for extracted fields",
        ...
        "acquisitionStep": "Run make gao-protest-feed-preflight to build an ignored GAO protest discovery worklist, extract decision metadata from the official decision pages, then manually link decisions to PIID, UEI, vendor, agency, and issue fields before promotion.",
