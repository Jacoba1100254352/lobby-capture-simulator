...
SOURCE_ROWS = [
    ...
    },
    {
        ...
        "fallbackSource": "Run make gao-protest-feed-preflight against the GAO Legal Products XML feed for ignored discovery, or make gao-protest-overlay-candidates to materialize likely protest rows into the tracked overlay with candidateOnly=true; the parser extracts B-numbers, decision dates, protester names, agency hints, awardee hints, coarse issue-code hints, and visible outcome language before source-page review",
        ...
        "acquisitionStep": "Run make gao-protest-overlay-candidates to refresh the candidate-only GAO protest review queue, review the high-priority rows against official decision pages or PDFs, then manually link decisions to PIID, UEI or vendor, agency, filed date, outcome, and issue fields before promotion.",
