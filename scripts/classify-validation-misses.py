...
CATEGORY_BY_METRIC = {
    ...
    "procurementAgencyTop1Share": ("direct-source-moment", "use the archived USAspending bulk summary for public agency-concentration diagnostics, then remap the benchmark by agency mix, award type, and fiscal year before treating agency concentration as calibrated"),
    "procurementRecipientTop3Share": ("direct-source-moment", "use the procurement benchmark crosswalk to keep aggregate, agency, award-type, and agency-award-type recipient concentration denominators separate"),
    ...
    "procurementExPostModificationShare": ("direct-source-moment", "use the procurement benchmark crosswalk to keep action-row, distinct-award, and amount-weighted modification denominators separate; add SAM/FPDS only for coding reconciliation"),
