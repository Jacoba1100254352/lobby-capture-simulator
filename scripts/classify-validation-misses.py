...
CATEGORY_BY_METRIC = {
    ...
    "procurementRecipientTop3Share": ("direct-source-moment", "use the archived USAspending bulk summary for public concentration diagnostics, then remap the top-contractor benchmark by award type, agency mix, and fiscal year before treating recipient concentration as calibrated"),
