...
CATEGORY_BY_METRIC = {
    ...
    "procurementAgencyTop1Share": ("direct-source-moment", "expand the procurement source panel beyond the EPA slice before treating agency concentration as representative"),
    "procurementRecipientTop3Share": ("direct-source-moment", "compare recipient concentration by agency, award type, and fiscal year rather than treating the EPA slice as a universal target"),
    ...
    "procurementExPostModificationShare": ("direct-source-moment", "fill SAM/FPDS modification fields and compare ex-post modification exposure against the procurement bridge target"),
