...
def audit():
    ...
    publisher_comments = publisher_comment.validate_all(
        publisher_inventory, publisher_followup, publisher_technology, publisher_infrastructure)
