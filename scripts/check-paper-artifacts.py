...
RELEASE_TAG = "paper-publication-readiness-2026-06-19-r208"
...
def check_first_wave_linkage_candidates() -> list[str]:
    ...
    required_text = [
        ...
        "P1 manual-review candidates",
        "Review Triage",
        "Review priority is a deterministic worklist ordering",
        "Linkage evidence class",
