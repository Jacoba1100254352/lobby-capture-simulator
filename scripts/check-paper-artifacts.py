...
RELEASE_TAG = "paper-publication-readiness-2026-06-18-r175"
...
def check_first_wave_source_products() -> list[str]:
    ...
    if ready_rows:
        ...
        for phrase in (
            ...
            "Candidate-only unreviewed products: `12`",
    ...
    required_text = [
        ...
        "procurement source-surface worklists require reviewed action-history, protest, exclusion, and firewall rows",
        "Template path",
        "Semantic Gate Notes",
        "Manual Promotion Checklists",
        "SAM/FPDS action-history export or keyed pull",
        ...
        "agency response text and final-rule linkage",
        "Candidate-only procurement source-surface worklist",
        "does not clear source-product readiness until action-history, protest, exclusion, and firewall rows",
    ]
    for phrase in required_text:
        if phrase not in text:
...
def check_first_wave_source_readiness() -> list[str]:
    ...
    required_text = [
        ...
        "SAM/FPDS action-history export or keyed pull; GAO protest overlay; SAM exclusion overlay; procurement firewall or integrity-control overlay",
