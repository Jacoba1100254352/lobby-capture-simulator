...
PANELS = [
    ...
    },
    {
        ...
        "evidenceClass": "direct bounded action/top-award panel",
        "minimum": 2.0,
        "good": 10.0,
        ...
        "action": "Replace the bounded USAspending concentration panel with representative SAM/FPDS action-level extracts before treating agency concentration as calibrated.",
    },
    {
