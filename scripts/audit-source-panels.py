...
def write_markdown(path: Path, rows: list[dict[str, str]]) -> None:
    ...
    lines = [
        ...
        "",
        f"- Coverage-status usable: `{counts['usable']}`",
        f"- Coverage-status thin: `{counts['thin']}`",
        f"- Coverage-status warning: `{counts['warning']}`",
        f"- Coverage-status fixture-only: `{counts['fixture-only']}`",
        f"- Coverage-status missing: `{counts['missing']}`",
        "",
