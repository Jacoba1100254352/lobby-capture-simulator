...
- split validation-facing source metrics for all-flow traceability, non-proxy direct dark-money routing rows, direct dark-money visibility, Schedule E/electioneering/communication-cost outside-spending pressure, resident voucher participation, candidate public-financing uptake, procurement bridge coverage, intermediary donor disclosure, revolving-door source confidence, and narrow reporting-error detection;
