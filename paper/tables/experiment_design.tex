...
\small \textbf{\tablename~\thetable.} Experiment and replication design. Experiments after the campaign snapshot use a high-gain stress-test contest mix designed to expose substitution and enforcement leakage.
\end{minipage}
\end{center}
\endgroup
