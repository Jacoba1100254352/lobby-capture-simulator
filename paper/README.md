...
The manuscript now carries the submission statements Wiley commonly expects for this kind of article: data/code availability, financial disclosure, conflicts of interest, and AI-use disclosure. Corresponding-author contact is taken from the local git configuration.
