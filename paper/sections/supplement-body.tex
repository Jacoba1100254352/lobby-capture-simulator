...
Additional composite-diagnostic variants for follow-up runs are:

\begin{itemize}
  \item equal-weight diagnostic: average observed capture, hidden capture, policy distortion, procurement bias, comment flooding, technical distortion, opacity, venue-shift load, and administrative burden;
  \item hidden-influence-discounted diagnostic: halve hidden influence, preserved influence, hidden capture, and substitution-risk terms before clamping;
  \item burden-heavy diagnostic: double administrative burden and chill weights, then report portfolio rankings separately from the main design loss.
\end{itemize}
