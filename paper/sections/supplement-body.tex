...
The main article's composite-weight table lists the implemented weights for total influence distortion and design loss. Total influence distortion is a clamped additive diagnostic over contest outcomes, hidden-channel diagnostics, information distortion, procurement pressure, comment flooding, opacity, venue shifting, and administrative burden. Design loss is used only for the portfolio screen and weights total distortion, hidden capture, substitution risk, administrative burden, opacity, legitimate-advocacy chill, and speech-restriction risk while rewarding cross-venue detection and participation protection.
