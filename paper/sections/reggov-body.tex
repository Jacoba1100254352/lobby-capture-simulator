...
The generated claim-boundary audit maps each source panel to its permitted manuscript claim boundary. Its support-level labels distinguish direct-bounded rows from direct/proxy, proxy, denominator-mapped, conditional-direct, and formally weak evidence, so usable source coverage is not automatically treated as representative empirical support.
