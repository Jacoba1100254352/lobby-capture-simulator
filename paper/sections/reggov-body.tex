...
The third limitation is calibration coverage. The validation and source-panel gates clear the mechanism article, including the former benchmark-scope partials for hidden-influence stress rows, public-financing candidate uptake, and regulator backlog. The remaining boundary is causal calibration rather than report-validation cleanup. Ten generated causal-calibration targets remain open for calibrated policy-simulation claims: hidden-donor routing, substitution elasticity, procurement-modification capture, revolving-door access, public-financing counterweights, comment authenticity and uptake, enforcement deterrence, meeting disclosure, intermediary networks, and venue-shifting detection. The first-wave source-product gate now includes a source-backed federal reform-shock event row, a meeting/contact missing-channel design note, a bounded 500-row public Regulations.gov comment-body corpus, reproducible duplicate/template cluster assignments for that corpus, a candidate-only response/final-rule linkage scaffold, and candidate-only entity-resolution seed files. The reform-shock row identifies the Honest Leadership and Open Government Act of 2007 as a dated official event for protocol design \citep{hloga2007}; it is not an actor-time panel or substitution estimate. The meeting note prevents private-access substitution from being silently ignored; it is not an observed access panel. The comment corpus and cluster file support duplicate-compression and authenticity-measurement design for one docket family. The response/final-rule linkage scaffold makes the intended agency-uptake coding unit inspectable, but it is not observed evidence of uptake until response sections, final-rule text movement, and uptake coding are manually adjudicated. The entity-resolution seeds turn automated cross-source name overlaps into review worklists; they are not adjudicated linkage evidence and do not make venue-shifting or substitution estimation-ready. The generated target audit separates first-wave empirical upgrades from later coverage work; the most immediate paths are a cross-source actor-issue-time spine anchored to the reform-shock row, exposed and comparison groups, a SAM/FPDS-style procurement action crosswalk with protest or exclusion overlays, a reviewed docket comment-authenticity and agency-response panel, and manual adjudication of the candidate entity-resolution spine. Additional empirical work would split source moments from simulated outcomes, link docket comments to agency responses, calibrate detection and sanction incidence against enforcement records, reconcile USAspending and SAM/FPDS modification coding, and anchor intermediary and revolving-door substitution with stronger panels. These steps would move the model from mechanism checking toward calibrated policy simulation.
