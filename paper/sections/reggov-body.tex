...
The main limitation is evidentiary rather than computational. The 2024 EPA/ENV slice supports schema validation and distributional diagnostics, and the multi-agency USAspending bridge improves procurement-concentration coverage. The source base remains incomplete for direct hidden-donor/source routing, representative national public financing beyond the local NYC and Seattle program rows, representative Form 990 nonprofit routing, complete IRS 527 coverage beyond the bounded alphabetic slice, representative SAM/FPDS procurement action histories, and revolving-door mechanisms beyond LDA covered-position rows. A stronger validation cycle would broaden the FEC panel beyond national party committees, Schedule E, and the bounded electoral-communication bridge; add federal, state, and additional local public-financing sources plus direct dark-money sources; replace capacity proxies with documented routing exports; and keep procurement concentration separate from simulated procurement bias.
